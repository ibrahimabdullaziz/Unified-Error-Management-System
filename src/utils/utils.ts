...
import { ERROR_REGISTRY } from "../core/registry";
import type { AppError } from "../types/types";
import { ErrorSeverity, ErrorUIState } from "../types/types";
...
export function getErrorSeverityClass(severity: ErrorSeverity): string {
  const classMap = {
    ...
    [ErrorSeverity.CRITICAL]:
      "bg-purple-50 dark:bg-purple-950 text-purple-900 dark:text-purple-100 border-purple-200 dark:border-purple-800",
  };
